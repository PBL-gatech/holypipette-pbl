...
class CalibrationConfig(Config):
    ...
    home_position =  Tuple((None, None, None), doc='Home position of the pipette in um')
    home_position_stage =  Tuple((None, None, None), doc='Home position of the stage in um')
    safe_position =  Tuple((None, None, None), doc='Safe position of the pipette in um')
    safe_position_stage =  Tuple((None, None, None), doc='Safe position of the stage in um')
    bath_position =  Tuple((None, None, None), doc='Bath position of the pipette in um')
