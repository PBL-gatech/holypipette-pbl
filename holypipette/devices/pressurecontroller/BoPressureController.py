...
class BoPressureController(PressureController):
    ...
    nativeZero = 2033 # The native units at a 0 pressure (y-intercept)
    nativePerMbar = float(2.9263) # The number of native pressure transducer units from the DAC (0 to 4095) in a millibar of pressure (-400 to 700)
