...
class PipetteDetector():
	...
	def __init__(self):
		...
		self.yoloNet = cv2.dnn.readNetFromONNX(curFile + '/pipetteModel/pipetteDetectorNetnano2.onnx') #real pipette
...
if __name__ == '__main__':
	...
	#detect pipette, draw location to img
	start = time.time()
	x,y = detector.detect_pipette(img)
